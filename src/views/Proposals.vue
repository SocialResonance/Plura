	...
	<div class="plura-proposals">
		<div class="proposals-header">
			...
			<div class="proposals-actions">
				...
				<div class="proposals-sorting">
					...
					<select v-model="sortBy" data-cy="sort-select" @change="loadProposals">
		...
		<div v-else class="proposals-list">
			<div
				...
				<div class="proposal-content">
					...
					<p class="proposal-description">
						{{ truncate(proposal.description, 150) }}
					</p>
			...
			<div class="proposals-pagination">
				...
				<button :disabled="proposals.length < limit" @click="nextPage">
					{{ t('plura', 'Next') }}
				</button>
			</div>
		</div>
				...
				<div class="proposal-form">
					...
					<div class="form-actions">
						<button class="primary"
							data-cy="proposal-submit-button"
		...
		<div v-if="selectedProposal" class="proposal-details-overlay">
			<div class="proposal-details-dialog">
				<div class="proposal-details-header">
					...
					<button class="close-button" @click="selectedProposal = null">
						×
					</button>
				</div>
